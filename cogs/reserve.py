...
class Reserve(commands.Cog):
    ...
    async def yoyaku(self, ctx):  # 予約内容の確認
        ...
        embed.add_field(name=f'{BOSSES[0]}',description=' '.join(res_b1))
        embed.add_field(name=f'{BOSSES[1]}',description=' '.join(res_b2))
        embed.add_field(name=f'{BOSSES[2]}',description=' '.join(res_b3))
        embed.add_field(name=f'{BOSSES[3]}',description=' '.join(res_b4))
        embed.add_field(name=f'{BOSSES[4]}',description=' '.join(res_b5))
